...
Расширяет класс Modal. Отвечает за реализацию модального окна, отображающего подробности о конкретном товаре. Позволяет добавлять в корзину. \
Поля класса:
- modal: HTMLElement — Элемент модального окна
- button: HTMLButtonElement - Кнопка добавления в корзину

Методы:
- addToCart(): void - добавление товара в корзину
...
- calculateSummary(): void - считает общую сумму заказа 
...
Отвечает за отображение массива с карточками товаров на главной странице. \
Предоставляет метод addProduct(productElement: HTMLElement) - для добавления товара на страницу и сеттер `container` для полного обновления содержимого.
...
- `order:validation` - валидация формы при оформлении заказа
